    ...
    <Link to={`/video/${video.videoId}`}>
      <div className='flex mb-3 mt-10'>
        ...
        <div className='flex flex-col ml-3 overflow-hidden'>
          ...
          <span className='text-[12px] lg:text-[10px] xl:text-[12px] mt-2 text-white/[.6] flex items-center'>
            {video?.author?.title}
            {(video?.author?.badges[0]?.type ===
              'VERIFIED_CHANNEL') && (
                <BsFillCheckCircleFill className='text-white/[.7] text-[12px] lg:text-[10px] xl:text-[12px] ml-1' />
              )}
          </span>
          <div className='flex text-[12px]text-[12px] lg:text-[10px] xl:text-[12px] font-semibold text-white/[.5] truncate overflow-hidden'>
            <span>
